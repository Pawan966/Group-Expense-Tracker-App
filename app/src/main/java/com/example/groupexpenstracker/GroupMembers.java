...
public class GroupMembers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expandingList = findViewById(R.id.expandlist);
        ...
        if(cursor.moveToFirst()){
            do{
                ExpandingItem item = expandingList.createNewItem(R.layout.expandable_list_members);
                ...
                innercursor = db.getExpensebyId(memId);
